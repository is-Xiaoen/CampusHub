...
func registerConsumers(svcCtx *svc.ServiceContext, chatRpcServer chat.ChatServiceServer) {
	...
	if svcCtx.UserCreditRpc != nil && svcCtx.UserVerifyRpc != nil {
		...
		logx.Info("  - activity.cancelled     -> chat-auto-disband-group")
