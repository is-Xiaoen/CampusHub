...
const file_user_proto_rawDesc = "" +
	...
	"\x10ProcessOcrVerify\x12\x19.user.ProcessOcrVerifyReq\x1a\x1a.user.ProcessOcrVerifyResp2\x8a\x02\n" +
	"\n" +
	"TagService\x127\n" +
	"\n" +
	...
	"\rUpdateUserTag\x12\x16.user.UpdateUserTagReq\x1a\x1b.user.UpdateUserTagResponse2\xfc\x04\n" +
...
var file_user_proto_goTypes = []any{
	...
	(*ForgetPasswordReq)(nil),        // 42: user.ForgetPasswordReq
	(*ForgetPasswordResponse)(nil),   // 43: user.ForgetPasswordResponse
	(*DeleteUserReq)(nil),            // 44: user.DeleteUserReq
	(*DeleteUserResponse)(nil),       // 45: user.DeleteUserResponse
	(*UpdatePasswordReq)(nil),        // 46: user.UpdatePasswordReq
	(*UpdatePasswordResponse)(nil),   // 47: user.UpdatePasswordResponse
	(*UpdateUserInfoReq)(nil),        // 48: user.UpdateUserInfoReq
	(*UpdateUserInfoResponse)(nil),   // 49: user.UpdateUserInfoResponse
	(*GetGroupUserReq)(nil),          // 50: user.GetGroupUserReq
	(*GetGroupUserResponse)(nil),     // 51: user.GetGroupUserResponse
	(*GroupUserInfo)(nil),            // 52: user.GroupUserInfo
	(*LoginReq)(nil),                 // 53: user.LoginReq
	(*LoginResponse)(nil),            // 54: user.LoginResponse
	(*LoginUserInfo)(nil),            // 55: user.LoginUserInfo
	(*LogoutReq)(nil),                // 56: user.LogoutReq
	(*LogoutResponse)(nil),           // 57: user.LogoutResponse
	(*RegisterReq)(nil),              // 58: user.RegisterReq
	(*RegisterResponse)(nil),         // 59: user.RegisterResponse
	(*GetUserInfoReq)(nil),           // 60: user.GetUserInfoReq
	(*GetUserInfoResponse)(nil),      // 61: user.GetUserInfoResponse
	(*InterestTag)(nil),              // 62: user.InterestTag
	(*UserInfo)(nil),                 // 63: user.UserInfo
	(*RefreshReq)(nil),               // 64: user.RefreshReq
	(*RefreshResponse)(nil),          // 65: user.RefreshResponse
	(*TagUsageCountReq)(nil),         // 66: user.TagUsageCountReq
	(*TagUsageCountResp)(nil),        // 67: user.TagUsageCountResp
	(*GetCaptchaConfigReq)(nil),      // 68: user.GetCaptchaConfigReq
	(*GetCaptchaConfigResponse)(nil), // 69: user.GetCaptchaConfigResponse
	(*CheckCaptchaReq)(nil),          // 70: user.CheckCaptchaReq
	(*CheckCaptchaResponse)(nil),     // 71: user.CheckCaptchaResponse
	(*CaptchaArgs)(nil),              // 72: user.CaptchaArgs
	(*SendQQEmailReq)(nil),           // 73: user.SendQQEmailReq
	(*SendQQEmailResponse)(nil),      // 74: user.SendQQEmailResponse
	(*CheckQQEmailReq)(nil),          // 75: user.CheckQQEmailReq
	(*CheckQQEmailResponse)(nil),     // 76: user.CheckQQEmailResponse
	(*UploadFileReq)(nil),            // 77: user.UploadFileReq
	(*UploadFileResponse)(nil),       // 78: user.UploadFileResponse
	(*DeleteFileReq)(nil),            // 79: user.DeleteFileReq
	(*DeleteFileResponse)(nil),       // 80: user.DeleteFileResponse
}
var file_user_proto_depIdxs = []int32{
	...
	52, // 8: user.GetGroupUserResponse.users:type_name -> user.GroupUserInfo
	55, // 9: user.LoginResponse.user_info:type_name -> user.LoginUserInfo
	63, // 10: user.LoginUserInfo.user_info:type_name -> user.UserInfo
	63, // 11: user.RegisterResponse.user_info:type_name -> user.UserInfo
	63, // 12: user.GetUserInfoResponse.user_info:type_name -> user.UserInfo
	62, // 13: user.UserInfo.interest_tags:type_name -> user.InterestTag
	72, // 14: user.CheckCaptchaResponse.captcha_args:type_name -> user.CaptchaArgs
	...
	29, // 28: user.VerifyService.ProcessOcrVerify:input_type -> user.ProcessOcrVerifyReq
	34, // 29: user.TagService.GetAllTags:input_type -> user.GetAllTagsReq
	36, // 30: user.TagService.GetTagsByIds:input_type -> user.GetTagsByIdsReq
	39, // 31: user.TagService.GetUserTags:input_type -> user.GetUserTagsReq
	31, // 32: user.TagService.UpdateUserTag:input_type -> user.UpdateUserTagReq
	50, // 33: user.UserBasicService.GetGroupUser:input_type -> user.GetGroupUserReq
	53, // 34: user.UserBasicService.Login:input_type -> user.LoginReq
	56, // 35: user.UserBasicService.Logout:input_type -> user.LogoutReq
	58, // 36: user.UserBasicService.Register:input_type -> user.RegisterReq
	64, // 37: user.UserBasicService.RefreshToken:input_type -> user.RefreshReq
	60, // 38: user.UserBasicService.GetUserInfo:input_type -> user.GetUserInfoReq
	46, // 39: user.UserBasicService.UpdatePassword:input_type -> user.UpdatePasswordReq
	48, // 40: user.UserBasicService.UpdateUserInfo:input_type -> user.UpdateUserInfoReq
	44, // 41: user.UserBasicService.DeleteUser:input_type -> user.DeleteUserReq
	42, // 42: user.UserBasicService.ForgetPassword:input_type -> user.ForgetPasswordReq
	66, // 43: user.TagBranchService.IncrTagUsageCount:input_type -> user.TagUsageCountReq
	66, // 44: user.TagBranchService.DecrTagUsageCount:input_type -> user.TagUsageCountReq
	68, // 45: user.CaptchaService.GetCaptchaConfig:input_type -> user.GetCaptchaConfigReq
	70, // 46: user.CaptchaService.CheckCaptcha:input_type -> user.CheckCaptchaReq
	73, // 47: user.QQEmail.SendQQEmail:input_type -> user.SendQQEmailReq
	75, // 48: user.QQEmail.CheckQQEmail:input_type -> user.CheckQQEmailReq
	77, // 49: user.UploadToQiNiu.UploadFile:input_type -> user.UploadFileReq
	79, // 50: user.UploadToQiNiu.DeleteFile:input_type -> user.DeleteFileReq
	1,  // 51: user.CreditService.GetCreditInfo:output_type -> user.GetCreditInfoResp
	4,  // 52: user.CreditService.GetCreditLogs:output_type -> user.GetCreditLogsResp
	6,  // 53: user.CreditService.CanParticipate:output_type -> user.CanParticipateResp
	8,  // 54: user.CreditService.CanPublish:output_type -> user.CanPublishResp
	10, // 55: user.CreditService.InitCredit:output_type -> user.InitCreditResp
	12, // 56: user.CreditService.UpdateScore:output_type -> user.UpdateScoreResp
	14, // 57: user.VerifyService.GetVerifyCurrent:output_type -> user.GetVerifyCurrentResp
	16, // 58: user.VerifyService.GetVerifyInfo:output_type -> user.GetVerifyInfoResp
	18, // 59: user.VerifyService.IsVerified:output_type -> user.IsVerifiedResp
	20, // 60: user.VerifyService.ApplyStudentVerify:output_type -> user.ApplyStudentVerifyResp
	23, // 61: user.VerifyService.ConfirmStudentVerify:output_type -> user.ConfirmStudentVerifyResp
	25, // 62: user.VerifyService.CancelStudentVerify:output_type -> user.CancelStudentVerifyResp
	28, // 63: user.VerifyService.UpdateVerifyStatus:output_type -> user.UpdateVerifyStatusResp
	30, // 64: user.VerifyService.ProcessOcrVerify:output_type -> user.ProcessOcrVerifyResp
	35, // 65: user.TagService.GetAllTags:output_type -> user.GetAllTagsResp
	37, // 66: user.TagService.GetTagsByIds:output_type -> user.GetTagsByIdsResp
	40, // 67: user.TagService.GetUserTags:output_type -> user.GetUserTagsResponse
	32, // 68: user.TagService.UpdateUserTag:output_type -> user.UpdateUserTagResponse
	51, // 69: user.UserBasicService.GetGroupUser:output_type -> user.GetGroupUserResponse
	54, // 70: user.UserBasicService.Login:output_type -> user.LoginResponse
	57, // 71: user.UserBasicService.Logout:output_type -> user.LogoutResponse
	59, // 72: user.UserBasicService.Register:output_type -> user.RegisterResponse
	65, // 73: user.UserBasicService.RefreshToken:output_type -> user.RefreshResponse
	61, // 74: user.UserBasicService.GetUserInfo:output_type -> user.GetUserInfoResponse
	47, // 75: user.UserBasicService.UpdatePassword:output_type -> user.UpdatePasswordResponse
	49, // 76: user.UserBasicService.UpdateUserInfo:output_type -> user.UpdateUserInfoResponse
	45, // 77: user.UserBasicService.DeleteUser:output_type -> user.DeleteUserResponse
	43, // 78: user.UserBasicService.ForgetPassword:output_type -> user.ForgetPasswordResponse
	67, // 79: user.TagBranchService.IncrTagUsageCount:output_type -> user.TagUsageCountResp
	67, // 80: user.TagBranchService.DecrTagUsageCount:output_type -> user.TagUsageCountResp
	69, // 81: user.CaptchaService.GetCaptchaConfig:output_type -> user.GetCaptchaConfigResponse
	71, // 82: user.CaptchaService.CheckCaptcha:output_type -> user.CheckCaptchaResponse
	74, // 83: user.QQEmail.SendQQEmail:output_type -> user.SendQQEmailResponse
	76, // 84: user.QQEmail.CheckQQEmail:output_type -> user.CheckQQEmailResponse
	78, // 85: user.UploadToQiNiu.UploadFile:output_type -> user.UploadFileResponse
	80, // 86: user.UploadToQiNiu.DeleteFile:output_type -> user.DeleteFileResponse
