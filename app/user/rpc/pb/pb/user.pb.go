...
const file_user_proto_rawDesc = "" +
	...
	"\faccess_token\x18\x01 \x01(\tR\vaccessToken2\x86\x03\n" +
	"\rCreditService\x12@\n" +
	...
	"\fRefreshToken\x12\x10.user.RefreshReq\x1a\x15.user.RefreshResponseB\x06Z\x04./pbb\x06proto3"
...
var file_user_proto_depIdxs = []int32{
	...
	1,  // 32: user.CreditService.GetCreditInfo:output_type -> user.GetCreditInfoResp
	4,  // 33: user.CreditService.GetCreditLogs:output_type -> user.GetCreditLogsResp
	6,  // 34: user.CreditService.CanParticipate:output_type -> user.CanParticipateResp
	8,  // 35: user.CreditService.CanPublish:output_type -> user.CanPublishResp
	10, // 36: user.CreditService.InitCredit:output_type -> user.InitCreditResp
	12, // 37: user.CreditService.UpdateScore:output_type -> user.UpdateScoreResp
	14, // 38: user.VerifyService.GetVerifyCurrent:output_type -> user.GetVerifyCurrentResp
	16, // 39: user.VerifyService.GetVerifyInfo:output_type -> user.GetVerifyInfoResp
	18, // 40: user.VerifyService.IsVerified:output_type -> user.IsVerifiedResp
	20, // 41: user.VerifyService.ApplyStudentVerify:output_type -> user.ApplyStudentVerifyResp
	23, // 42: user.VerifyService.ConfirmStudentVerify:output_type -> user.ConfirmStudentVerifyResp
	25, // 43: user.VerifyService.CancelStudentVerify:output_type -> user.CancelStudentVerifyResp
	28, // 44: user.VerifyService.UpdateVerifyStatus:output_type -> user.UpdateVerifyStatusResp
	30, // 45: user.TagService.GetAllTags:output_type -> user.GetAllTagsResp
	32, // 46: user.TagService.GetTagsByIds:output_type -> user.GetTagsByIdsResp
	35, // 47: user.TagService.GetUserTags:output_type -> user.GetUserTagsResponse
	37, // 48: user.UserBasicService.GetGroupUser:output_type -> user.GetGroupUserResponse
	40, // 49: user.UserBasicService.Login:output_type -> user.LoginResponse
	44, // 50: user.UserBasicService.Logout:output_type -> user.LogoutResponse
	46, // 51: user.UserBasicService.Register:output_type -> user.RegisterResponse
	49, // 52: user.UserBasicService.RefreshToken:output_type -> user.RefreshResponse
