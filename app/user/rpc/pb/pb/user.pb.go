...
var file_user_proto_depIdxs = []int32{
	...
	50, // 32: user.CaptchaService.GetCaptchaConfig:input_type -> user.GetCaptchaConfigReq
	52, // 33: user.CaptchaService.CheckCaptcha:input_type -> user.CheckCaptchaReq
	...
	51, // 55: user.CaptchaService.GetCaptchaConfig:output_type -> user.GetCaptchaConfigResponse
	53, // 56: user.CaptchaService.CheckCaptcha:output_type -> user.CheckCaptchaResponse
